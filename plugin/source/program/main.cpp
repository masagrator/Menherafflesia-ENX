...
extern "C" void exl_main(void* x0, void* x1) {
	*(uint64_t*)exl::util::modules::GetTargetOffset(0x18AF50) = (uint64_t)&ENG::CHAPTERS;
	*(uint64_t*)exl::util::modules::GetTargetOffset(0x18B700) = (uint64_t)&ENG::NOTIFICATIONS;
	*(uint64_t*)exl::util::modules::GetTargetOffset(0x18AF58) = (uint64_t)&ENG::PLAYING_LOG_MAIN;
	*(uint64_t*)exl::util::modules::GetTargetOffset(0x18B380) = (uint64_t)&ENG::SETTINGS_DESCRIPTIONS;
	*(uint64_t*)exl::util::modules::GetTargetOffset(0x18AF70) = (uint64_t)&ENG::ENDINGS;

	exl::hook::Initialize();

	LoadXTXTexture::InstallAtOffset(0x13100);
	ShowKeyboard::InstallAtFuncPtr(_ZN2nn5swkbd12ShowKeyboardEPNS0_6StringERKNS0_15ShowKeyboardArgE);

	exl::patch::CodePatcher patcher{0x3E394};
	uint64_t save_text_address = (uint64_t)exl::util::modules::GetTargetOffset(0x3E394) & ~0xFFF;
	...
	patcher.Seek(0x18030);
	save_text_address = (uint64_t)exl::util::modules::GetTargetOffset(0x18030) & ~0xFFF;
	...
	patcher.Seek(0x18268);
	save_text_address = (uint64_t)exl::util::modules::GetTargetOffset(0x18268) & ~0xFFF;
	...
	patcher.Seek(0x17FE0);
	save_text_address = (uint64_t)exl::util::modules::GetTargetOffset(0x17FE0) & ~0xFFF;
	save_text0 = (uint64_t)ENG::YES_NO[2] - save_text_address;
	patcher.WriteInst(exl::armv8::inst::Adrp(exl::armv8::reg::X0, save_text0 & ~0xFFF));
	patcher.WriteInst(exl::armv8::inst::AddImmediate(exl::armv8::reg::X0, exl::armv8::reg::X0, save_text0 & 0xFFF));
	patcher.Seek(0x1813C);
	save_text_address = (uint64_t)exl::util::modules::GetTargetOffset(0x1813C) & ~0xFFF;
	save_text0 = (uint64_t)ENG::YES_NO[2] - save_text_address;
	patcher.WriteInst(exl::armv8::inst::Adrp(exl::armv8::reg::X0, save_text0 & ~0xFFF));
	patcher.WriteInst(exl::armv8::inst::AddImmediate(exl::armv8::reg::X0, exl::armv8::reg::X0, save_text0 & 0xFFF));

	patcher.Seek(0x180F4);
	save_text_address = (uint64_t)exl::util::modules::GetTargetOffset(0x180F4) & ~0xFFF;
	save_text0 = (uint64_t)ENG::YES_NO[3] - save_text_address;
	patcher.WriteInst(exl::armv8::inst::Adrp(exl::armv8::reg::X0, save_text0 & ~0xFFF));
	patcher.WriteInst(exl::armv8::inst::AddImmediate(exl::armv8::reg::X0, exl::armv8::reg::X0, save_text0 & 0xFFF));
	patcher.Seek(0x18250);
	patcher.WriteInst(exl::armv8::inst::Adrp(exl::armv8::reg::X0, save_text0 & ~0xFFF));
	patcher.WriteInst(exl::armv8::inst::AddImmediate(exl::armv8::reg::X0, exl::armv8::reg::X0, save_text0 & 0xFFF));

	patcher.Seek(0x3D510);
	save_text_address = (uint64_t)exl::util::modules::GetTargetOffset(0x3D510) & ~0xFFF;
	...
	patcher.Seek(0x1D1EC);
	save_text_address = (uint64_t)exl::util::modules::GetTargetOffset(0x1D1EC) & ~0xFFF;
	...
	patcher.WriteInst(exl::armv8::inst::Adrp(exl::armv8::reg::X20, save_text0 & ~0xFFF));
	patcher.WriteInst(exl::armv8::inst::AddImmediate(exl::armv8::reg::X20, exl::armv8::reg::X20, save_text0 & 0xFFF));
	patcher.Seek(0x20884);
	patcher.WriteInst(exl::armv8::inst::Adrp(exl::armv8::reg::X20, save_text0 & ~0xFFF));
	patcher.WriteInst(exl::armv8::inst::AddImmediate(exl::armv8::reg::X20, exl::armv8::reg::X20, save_text0 & 0xFFF));

	patcher.Seek(0xF8B4);
	save_text_address = (uint64_t)exl::util::modules::GetTargetOffset(0xF8B4) & ~0xFFF;
	...
	patcher.Seek(0xF980);
	save_text_address = (uint64_t)exl::util::modules::GetTargetOffset(0xF980) & ~0xFFF;
